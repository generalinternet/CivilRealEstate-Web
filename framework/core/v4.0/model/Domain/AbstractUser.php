...
abstract class AbstractUser extends GI_Model {
    ...
    public function getUserAvatarHTML($width = NULL, $height = NULL){
        ...
        if($avatarView){
            ...
            return '<span class="avatar_wrap avatar_placeholder inline_block"><span class="icon avatar"></span></span>';
        }
    }
     ...
     * @return string URL
     */
    public function getViewURL($ajax = false) {
        $viewURLAttributes = $this->getViewURLAttrs();
        if ($ajax) {
            $viewURLAttributes['ajax'] = '1';
        }
        return GI_URLUtils::buildURL($viewURLAttributes);
    }
    ...
    public function getAutocompResult($term = NULL) {
        ...
        if ($avatarView) {
            ...
            $avatar = '<span class="avatar_wrap avatar_placeholder inline_block"><span class="icon avatar"></span></span>';
        }
